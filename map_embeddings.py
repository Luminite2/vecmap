...
def main():
    ...
    self_learning_group.add_argument('--orthographic_sim', action='store_true', help='use edit distance when calculating similarity')
    ...
    if args.orthographic_sim:
      ortho_sim = ortho.load_sparse_csr() #TODO: generalize
